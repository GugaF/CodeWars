...
// especially since the exit is located right behind your row to the left. All you need to do is 
// climb over your seat and make your way to the exit.

// The main problem is your shyness: you're afraid that you'll end up blocking the view (even if 
// only for a couple of seconds) of all the people who sit behind you and in your column or the 
// columns to your left. To gain some courage, you decide to calculate the number of such people 
