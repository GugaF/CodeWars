...
// three states: q1, q2, and q3. Here is the description of the states:
...
// Your task
// You will have to design your state objects, and how your Automaton handles transitions. Also 
// make sure you set up the three states, q1, q2, and q3 for the myAutomaton instance. The test 
// fixtures will be calling against myAutomaton.
...
class Automaton{
    ...
    readCommands(commands) {
      commands.forEach((change, i) => {
        if (this.state === "q1" && change === "1") { 
          this.state = "q2"
        } else { 
          if (this.state === "q2" && change === "0") { 
            this.state = "q3" 
          } else { 
            if (this.state === "q3") { 
              this.state = "q2" 
...
var a = new Automaton();
console.log(a.readCommands(["1", "0", "0", "1", "0"]), false);
console.log(a.readCommands(["1"]), true);
console.log(a.readCommands(["1", "0", "0", "1"]), true);