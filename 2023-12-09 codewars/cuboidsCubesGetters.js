...
// 7 Kyu - Fun with ES6 Classes #3 - Cuboids, Cubes and Getters
...
// The class Cuboid should then have a getter surfaceArea which returns the 
// surface area of the cuboid and a getter volume which returns the volume of the cuboid.

// II. Cube
// class Cube is a subclass of class Cuboid. The constructor function of Cube should receive 
// one argument only, its length, and use that value passed in to set this.length, this.width and this.height.
