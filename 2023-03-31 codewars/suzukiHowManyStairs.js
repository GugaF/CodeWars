...
// 8th Kyu - How many stairs will Suzuki climb in 20 years?
...
// depending on the number of students he must train in the morning. He is curious how many stairs might be climbed over the next 20 years 
// and has spent a year marking down his daily progress.

// The sum of all the stairs logged in a year will be used for estimating the number he might climb in 20.
// 20_year_estimate = one_year_total * 20

// You will receive the following data structure representing the stairs Suzuki logged in a year. You will have all data for the entire year so regardless of how it is logged 
// the problem should be simple to solve.
...
// P: a 2 dimensional array, where the first dimension is the days of the week
    // the 2nd dimension is the number of steps climbed that day
// R: 20 year estimate based on one year's steps
// E: see below
// P: count all the steps taken in one year, and multiply it by 20
...
function stairsIn20(s){
    ...
    return s.reduce((acc1, curr1)=> acc1 += curr1.reduce((acc2, curr2) => acc2 + curr2, 0 ), 0) * 20
}
