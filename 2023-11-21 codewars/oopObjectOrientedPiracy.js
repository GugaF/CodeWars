...
// OOP you wish to make a pretty efficient system to identify ships with heavy 
// booty on board!

// Unfortunately for you, people weigh a lot these days, so how do you know if a 
// ship is full of gold and not people?
...
// Second Try: within the given function
function Ship(draft, crew) {
    this.draft = draft;
    this.crew = crew;
