...
// P: direction as a string (L or R), array of Heights
// R: return the array as if all boxes are pushed to the left or right depending on the direction provided
// E: see above
// P: if the input direction is R sort the array in ascending order
    // if the input direction is L sort the array in descending order
