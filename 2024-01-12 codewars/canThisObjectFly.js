...
// The story of the famous Disney-Pixar animated movie "Up" is based on the 
// main character Carl Fredricksen journey in his home equipped with balloons.
// But can this happen for real? What kind of objects can you lift with helium 
// balloons? How many balloons do you need?
...
// which means starting a new journey to Gravity Falls in a house with 2 members 
// of crew (Carl and Russel).

// But is this journey possible? Will the house float? Is it enough to have 20622 helium 
// balloons (the number used by Pixar animators in liftoff scene)?

// Your Journey class should have a public method isPossible() that returns true or false 
// based on these rules:

//     1). Every object passed to Journey will have its weight property like
//         var house = {"weight": 45000};  (we will use metric system in this kata, 45 000 kg is about 100 000 pounds).
...
// Can you lift a tiny 95 kg push cart with 50 balloons like in one of the starting scenes of the movie?
