...
// helper function they wrote so that it works as intended (i.e. make the first character 
// in the string "word" upper case).

// Don't worry about numbers, special characters, or non-string types being passed to the 
// function. The string lengths will be from 1 character up to 10 characters, but will 
// never be empty.
