...
// II. Cat
// The constructor function for Cat should accept the same 3 arguments as with
// Shark: name, age, status. Cats should always have a leg count of 4 and a species of "cat".
...
// III. Dog
// The Dog constructor should accept 4 arguments in the specified order: name, 
// age, status, master. master is the name of the dog's master which will be a string. 
...
// own method called greetMaster/GreetMaster which accepts no arguments and returns 
// "Hello (insert_master_name_here)" (of course not the literal string but replace the 
